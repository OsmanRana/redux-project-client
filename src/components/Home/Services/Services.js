    ...
    return (
        <div id="about" className="container ">
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4  text-start my-5">
                <div className="col col-sm-12 col-md-12 col-lg-4 px-5">
                    ...
                    <button className="fs-5 my-5 button">MEET OUR LEADERSHIP</button>
                </div>
                <div className="col col-sm-12 col-md-12 col-lg-4 bg-dark text-white p-5">
                    <h3>Core Values</h3>
